...
Manage webhooks in App Store Connect to receive real-time notifications about events such as build processing and beta feedback updates.
...
Both date filters are optional and can be combined to request a bounded range.
