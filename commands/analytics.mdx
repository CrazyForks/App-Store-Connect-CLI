...
* `--date` - Report date (format depends on frequency; optional for `DAILY`)
* `--version` - Report format version (for example, `1_0`, `1_2`, `1_3`, or `1_4`). Defaults to `1_4` for `SUBSCRIPTION`, `1_3` for `SUBSCRIBER`, `1_2` for monthly `INSTALLS`, and `1_0` otherwise
