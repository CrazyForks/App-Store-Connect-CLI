...
- API 4.4.1 has no marketplace-webhook instance GET operation. Read marketplace webhook information with the supported collection-level `asc marketplace webhooks list` command.
